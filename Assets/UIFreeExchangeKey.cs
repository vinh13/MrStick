...
public class UIFreeExchangeKey : MonoBehaviour
{
	...
	public void ShowExchangeKey (Action<object> a, int coin)
	{
	...
	void ClickEquip ()
	{
		btnBack.Block (true);
		btnEquip.Block (true);
		AllInOne.Instance.ShowVideoReward (cbVideo,"FreeExchange_key",LevelData.IDLevel);
	}
